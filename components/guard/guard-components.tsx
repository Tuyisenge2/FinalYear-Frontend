...
// ============================================================================
// GUARD_INTEGRATION_POINT: Replace mock alert data with real-time WebSocket data
// TODO: Connect to WebSocket endpoint for live alerts
// const ws = new WebSocket(`${WS_URL}/guard/:guardId/alerts`);
// ws.onmessage = (event) => { addNewAlert(JSON.parse(event.data)); };
// ============================================================================

// AlertFeed component - Shows incoming alerts for guard dashboard
interface AlertItem {
  id: string;
  type: string;
...
// TODO: Replace with live data from WebSocket/API
